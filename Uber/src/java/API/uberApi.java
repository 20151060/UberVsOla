...
public class uberApi {
    ...
    uberApi ua = new uberApi();
        try {
            ua.getPrice(37.7752315, -122.418075, 37.7752415, -122.518075);
        } catch (Exception ex) {
            Logger.getLogger(uberApi.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
    private void getPrice(double slat, double slog , double elat, double elog) throws Exception{
