...
public class lyftApi {
    ...
    String url = "https://api.lyft.com/v1/cost?start_lat=" + slat + "&start_lng=" + slog + "&end_lat=" + elat + "&end_lng=" + elog + "";
		URL obj = new URL(url);
		...
		//con.setRequestProperty("User-Agent", USER_AGENT);
                ...
                con.setRequestProperty("User-Agent", USER_AGENT);
                con.setRequestProperty("Authorization", "Bearer mGBERaxlVTyUqqTsCwmO8Xwva2GphIeclUGogUbtGMVEkKptoQ5Y+cyL8STBy6eONK+ePoyYuOrAn74biWO8wf4w5ERkYxOhtfdAO+ESkUkco+OMfA48J2c="); 
		...
		//print result
		 String x = response.toString() ;
                 ...
                 System.out.println(r.getrideType() + " : " + "$" + r.getpriceMin() + "-" + r.getpriceMax());
                 }*/
    ...
    private ArrayList<rideInfo> jsonParser(String x) {
      ArrayList<rideInfo> arr = new ArrayList<rideInfo>();
        try {
            ...
            JSONArray ja = (JSONArray) jo.get("cost_estimates");
            
            for(int i=0;i<ja.size();i++)
{
   JSONObject jo1 = (JSONObject)ja.get(i);
    String s = (String) jo1.get("display_name");
    long y = (long) jo1.get("estimated_cost_cents_min");
    long z = (long) jo1.get("estimated_cost_cents_max");
    rideInfo r = new rideInfo(s,y,z);
    arr.add(r);
}
